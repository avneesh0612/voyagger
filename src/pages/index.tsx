...
const Home: React.FC = () => {
  ...
  return (
    <div>
      <div className="absolute top-[60%] left-[0%] md:left-[20%] w-96 h-96 bg-purple-300 rounded-full mix-blend-multiply filter blur-lg opacity-90 animate-blob"></div>
      <div className="absolute top-[70%] left-[50%] w-96 h-96 bg-red-400 rounded-full mix-blend-multiply filter blur-lg opacity-90 animate-blob animation-delay-2000"></div>
      <div className="absolute top-[75%] md:top-[60%] left-[10%] md:left-[30%] w-96 h-96 bg-indigo-400 rounded-full mix-blend-multiply filter blur-lg opacity-90 animate-blob animation-delay-4000"></div>
